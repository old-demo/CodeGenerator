...
public interface DatebaseRepository {
     ...
     * @return 成功数量
     */
    int deleteBatchDatebaseByParam(DatebaseEntity datebase);
     ...
     * @return 成功数量
     */
    int updateDatebaseByKey(DatebaseEntity datebase);
     ...
     * @return 是否成功
     */
    int updateBatchDatebaseByKey(List<DatebaseEntity> datebaseList);
