...
public class AdminController {
    ...
    public ResponseUtil updateAdminByKey(@RequestBody AdminRequest adminRequest) {
        if(adminRequest.getAdName() == null) {
            return new ResponseUtil(0, "管理员姓名不能为null！", null);
        }
        if(adminRequest.getAdSex() == null) {
            return new ResponseUtil(0, "管理员性别不能为null！", null);
        }
        if(adminRequest.getAdAge() == null) {
            return new ResponseUtil(0, "年龄不能为null！", null);
        }
        if(adminRequest.getAdId() == null) {
            return new ResponseUtil(0, "管理员编号不能为null！", null);
        }
        Admin admin = adminRequest.getAdmin();
        if(admin == null) {
            return new ResponseUtil(0, "不能为null！", null);
